            ...
            btns.push(
                <li
                    ...
                    className={`${pageNumber === i 
                        ...
                        : 'bg-slate-700 hover:bg-indigo-500 shadow-lg hover:shadow-indigo-500/50 hover:text-white text-[#d0d2d6]'} w-[33px] h-[33px] rounded-full flex justify-center items-center cursor-pointer'
                    `}
                >
                    {i}
                </li>
